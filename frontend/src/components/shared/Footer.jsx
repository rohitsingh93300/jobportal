...
const Footer = () => {
  return (
    <footer className="border-t bg-white border-t-gray-200 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div onClick={() => navigate('/')} className='cursor-pointer'>
              <h1 className='text-2xl font-bold md:text-start text-center'>Job<span className='text-[#F83002]'>Portal</span></h1>
            </div>
